    ...
    return (
        <>
            ...
            {answeredCorrectly === true && (
                <Animated.View entering={SlideInDown}  exiting={SlideInDown.duration(2000)} className="bg-gray-100 rounded-t-xl px-4 pt-3 border border-gray-300 h-36" style={[styles.answerBox, styles.correctAnswerBox]}>
            ...
            {answeredCorrectly === false && (
                <Animated.View entering={SlideInDown}  exiting={SlideInDown.duration(2000)} className="bg-gray-100 rounded-t-xl px-4 pt-3 h-36" style={[styles.answerBox, styles.wrongAnswerBox]}>
